...
function Cover() {
    return <div className="items-center text-grey400 mb-24 md:my-36">
        <div className="flex flex-wrap-reverse flex-col-reverse md:flex-row items-center justify-center">
            {/* my info */}
            <section className="justify-center px-16 md:px-72">
                <div className="flex flex-col text-left text-6xl md:text-9xl font-semibold font-alata">
                    <div className='w-128'>
                        ...
                        <h1 id='shadow' className=" text-white pl-6 pt-6 md:pl-9 md:pt-9 font-bold">FERIN</h1>
                    </div>
                    <div>
                        ...
                        <h1 id='shadow' className=" text-white pl-6 pt-6 md:pl-9 md:pt-9 font-bold">CHOWARUN</h1>
                    </div>
                </div>
            ...
            <section className="justify-center my-auto p-16">
                <img id='portrait-shadow' className='md:w-80 md:min-w-72 w-52 min-w-52' src={portrait} alt="" />
            </section>
        </div>
